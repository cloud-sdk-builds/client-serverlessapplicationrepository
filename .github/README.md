...
[`@aws-sdk/client-serverlessapplicationrepository`](https://www.npmjs.com/package/@aws-sdk/client-serverlessapplicationrepository/v/3.1113.0).
...
- @aws-sdk/client-serverlessapplicationrepository v3.1113.0 - [https://cloud-sdk-builds.github.io/?sdk=client-serverlessapplicationrepository&version=3.1113.0](https://cloud-sdk-builds.github.io/?sdk=client-serverlessapplicationrepository&version=3.1113.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.1113.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1XICy/X7EG82+vqChMIaI+z2+vsSHBdgsp6noFstfx5gWN+QgvqUgI27iYyDyXg9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-serverlessapplicationrepository": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.1113.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.1113.0/index.min.mjs": "sha384-1XICy/X7EG82+vqChMIaI+z2+vsSHBdgsp6noFstfx5gWN+QgvqUgI27iYyDyXg9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-serverlessapplicationrepository/blob/refs/tags/3.1113.0/LICENSE
```
