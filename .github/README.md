...
[`@aws-sdk/client-serverlessapplicationrepository`](https://www.npmjs.com/package/@aws-sdk/client-serverlessapplicationrepository/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HuaVp/R+jqqmv9r9H3YZLNjavIdyE1SYZxgbfNlTGS8fnAjxX5SCkiBZs31gtHRk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-serverlessapplicationrepository": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-serverlessapplicationrepository@3.21.0/index.min.mjs": "sha384-HuaVp/R+jqqmv9r9H3YZLNjavIdyE1SYZxgbfNlTGS8fnAjxX5SCkiBZs31gtHRk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-serverlessapplicationrepository/blob/refs/tags/3.21.0/LICENSE
```
